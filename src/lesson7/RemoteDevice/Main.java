...
public class Main {
    public static void main(String[] args) {
        TV tcl = new TV();
        RemoteController tclController = new RemoteController();
        tclController.connectDevice(tcl);
        tclController.powerOn();
        tclController.setChannel(20);
        tclController.currentChannel();
        tclController.upVolume();
        tclController.switchTheChannel(2);
        tclController.currentChannel();
        tclController.upVolume();
        tclController.downVolume();
        tclController.powerOff();
        tclController.disconnectDevice();
    }
}