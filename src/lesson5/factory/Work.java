...
/*
7. Answer the question: What is a package-private access? Create a simple program to demonstrate
the package-private access.
Tips:
...
public class Work {
    ...
    void showEmployees(){
        System.out.printf("Employees: %d", employees);
    }
